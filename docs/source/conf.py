...
copyright = '2016, Rémi Flamary, Nicolas Courty'
...
latex_documents = [
    (master_doc, 'POT.tex', 'POT Python Optimal Transport library',
     'Rémi Flamary, Nicolas Courty', 'manual'),
]
...
man_pages = [
    (master_doc, 'pot', 'POT Python Optimal Transport library Documentation',
     [author], 1)
]
